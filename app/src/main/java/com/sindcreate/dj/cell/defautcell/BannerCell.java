...
public class BannerCell extends RVBaseCell<List<NewsBean>> {
    public static final int TYPE = 2;
    private ConvenientBanner mConvenientBanner;
    public BannerCell(List<NewsBean> newsBeans) {
        super(newsBeans);
    }
    ...
    public static class NetworkImageHolderView implements CBPageAdapter.Holder<NewsBean>{
        ...
        public void UpdateUI(Context context, int position, NewsBean data) {
            Glide.with(context).load(data.getCoverPicUrl()).into(imageView);
