...
public class OkHttpUtils {
    ...
    public static void sendNetErrorResultCallback(final HttpCallback callback) {
        if (callback == null) {
            return;
        }
        mPlatform.execute(new Runnable() {
    ...
    public static void postAsynFile(String url, File file, HttpCallback callback) {
        if (!file.exists()) {
            ToastUtil.showText(UiUtil.getString(R.string.file_does_not_exist));
            return;
        }
     ...
     * @Description 文件下载
     */
    public static void downloadAsyncFile(String url, String destFileDir, String destFileName, HttpCallback callback) {
        Request request = OkHttpRequest.builderRequest(OkHttpRequest.HttpMethodType.GET, url, null, null);
     ...
     * @Description 文件下载
     */
    public void downloadAsyncFile(String url, String destFileDir, String destFileName, Map<String, String> params, HttpCallback callback) {
        Request request = OkHttpRequest.builderRequest(OkHttpRequest.HttpMethodType.POST, url, params, null);
        OkHttpRequest.doDownloadEnqueue(request, destFileDir, destFileName, callback);
    }
     ...
     * @Description 文件下载
     */
    public static void downloadAsynJsonFile(String url, String destFileDir, String destFileName, String json, HttpCallback callback) {
        Request request = OkHttpRequest.builderRequest(OkHttpRequest.HttpMethodType.POST, url, null, json);
        OkHttpRequest.doDownloadEnqueue(request, destFileDir, destFileName, callback);
    }
    /**--------------------    图片显示    --------------------**/
