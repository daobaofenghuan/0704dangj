...
public class XindeHelpAdapter extends RecyclerView.Adapter<XindeHelpAdapter.ViewHolder> {
...
private  Activity ac;
    public XindeHelpAdapter(Context mContext, List<Bitmap> data, Activity ac) {
        ...
        new MPopupWindows(mContext,holder.picview,ac);
          ...
          holder.wrongly.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  ...
                  msg.what = MsgNum.OK;
                  msg.obj = position;
                  Mydata.xindehandler.sendMessage(msg);
              }
          });
      }
