...
import static com.sindcreate.dj.bean.MsgNum.MSG_DangRI;
import static com.sindcreate.dj.bean.MsgNum.MSG_Home;
import static com.sindcreate.dj.bean.MsgNum.MSG_SanHui;
import static com.sindcreate.dj.bean.MsgNum.MSG_Work;
import static com.sindcreate.dj.bean.MsgNum.MSG_XiaoXI;
import static com.sindcreate.dj.bean.MsgNum.MSG_ZAIXIANKAOSHI;
import static com.sindcreate.dj.bean.MsgNum.MSG_edu;

import static com.sindcreate.dj.bean.MsgNum.Refresh_HomePage;
...
//                }
                ...
                fragment2 = new EducationFragment2();
                mFragmentTransaction.replace(R.id.fragment_container, fragment2);
                break;
            case 3:
//                if (fragment3 == null) {
...
//                }
                fragment3 = new ServiceFragment();
                mFragmentTransaction.replace(R.id.fragment_container, fragment3);
                break;
...
//                }
                fragment4 = new MyFragment();
                mFragmentTransaction.replace(R.id.fragment_container, fragment4);
                break;
...
//                }
                messageFragment = new MessageFragment();
                mFragmentTransaction.replace(R.id.fragment_container, messageFragment);
                break;
            case 6:
...
//                }
                dangRi_fragemnt6 = new Part_DangRI_Fragmenttwo();
                mFragmentTransaction.replace(R.id.fragment_container, dangRi_fragemnt6);
                break;
...
//                } else {
//                    mFragmentTransaction.remove(sanHuiYiKe_fragment7);
//                    sanHuiYiKe_fragment7=new Part_SanHuiYiKe_Fragment();
//                    mFragmentTransaction.add(R.id.fragment_container, sanHuiYiKe_fragment7);
//                    mFragmentTransaction.show(sanHuiYiKe_fragment7);
//                }
                sanHuiYiKe_fragment7=new Part_SanHuiYiKe_Fragment();
                mFragmentTransaction.replace(R.id.fragment_container, sanHuiYiKe_fragment7);
                break;
            case 8:
...
//                }
                zaiXian_fragment8= new Part_ZaiXian_Fragment();
                mFragmentTransaction.replace(R.id.fragment_container, zaiXian_fragment8);
                break;
            case 9:
...
//                }
                work_fragment9 = new Part_Work_fragment1();
                mFragmentTransaction.replace(R.id.fragment_container, work_fragment9);
                break;
